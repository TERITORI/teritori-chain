...
func queryTeritoriTx(endpoint, txHash string) error {
...
func getSpecificBalance(endpoint, addr, denom string) (amt sdk.Coin, err error) {
	balances, err := queryTeritoriAllBalances(endpoint, addr)
	if err != nil {
		return amt, err
	}
...
func queryTeritoriAllBalances(endpoint, addr string) (sdk.Coins, error) {
