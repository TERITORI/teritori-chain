...
/*
AddRemoveConsumerChain tests adding and subsequently removing a new consumer chain to Teritori.
Test Benchmarks:
...
func (s *IntegrationTestSuite) AddRemoveConsumerChain() {
	...
	s.execQueryConsumerChains(s.chainA, 0, teritoriHomePath, validateConsumerAddition, consumerChainID)
	...
	s.execQueryConsumerChains(s.chainA, 0, teritoriHomePath, validateConsumerRemoval, consumerChainID)
}
