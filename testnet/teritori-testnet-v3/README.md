...
```shell
wget -O ~/.teritorid/config/genesis.json https://raw.githubusercontent.com/TERITORI/teritori-chain/teritori-testnet-v3/testnet/teritori-testnet-v3/genesis.json
```  
