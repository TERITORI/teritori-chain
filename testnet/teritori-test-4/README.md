...
```shell
git clone https://github.com/TERITORI/teritori-chain && cd teritori-chain && git checkout v1.4.1 && make install
```  

Verify the installation:  
```shell
teritorid version
#Should return v1.4.0
```  

Init the chain:
```shell
teritorid init <YOUR_MONIKER> --chain-id teritori-test-4
```  
...
```shell
wget -O ~/.teritorid/config/genesis.json https://raw.githubusercontent.com/TERITORI/teritori-chain/main/testnet/teritori-test-4/genesis.json
```  
...
- [Manual](https://github.com/TERITORI/teritori-chain/tree/main/testnet/teritori-test-4#Manual)
- [Systemctl](https://github.com/TERITORI/teritori-chain/tree/main/testnet/teritori-test-4#Systemctl)
- [Cosmovisor](https://github.com/TERITORI/teritori-chain/tree/main/testnet/teritori-test-4#Cosmovisor)
...
```shell
teritorid query bank balances <YOUR_TERITORI_ADDRESS> --chain-id teritori-test-4
```  
